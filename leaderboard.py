...
#update_leaderboard("a122_leaderboard.txt", ["Sam", "Jack", "Adam"], [9, 7, 4], "Mabel", 10)
...
def draw_leaderboard(leader_names, leader_scores, high_scorer, turtle_object, player_score):
  ...
  elif (player_score >= gold_score and player_score < god_score):
    turtle_object.write("You earned a Gold medal!", font=font_setup)
  elif (player_score >= god_score and player_score < God_score):
    turtle_object.write("You are a god!", font=font_setup)
  elif (player_score >= God_score):
    turtle_object.write("Holy cannoli! You are a God!", font=font_setup)